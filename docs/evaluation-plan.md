...
- Local Assistants compatibility runs deprecated Assistants/Threads workflows
  ...
  `message_creation` Run Steps, and verifies create-and-run lifecycle SSE event
  shape.
