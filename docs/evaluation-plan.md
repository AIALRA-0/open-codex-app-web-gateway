...
- Local Organization usage/costs coverage queries costs plus representative
  completions, images, file-search, and web-search usage endpoints, validates
  zero-value bucket/result shapes, and checks invalid/missing parameter errors
  without contacting the upstream Chat provider.
