...
| `bridge-regression` | Protocol smoke plus Chat passthrough, stored Chat lifecycle, Responses input-token counting, local compaction continuation, SSE events, function-tool `tool_choice`, and `previous_response_id` replay |
