...
- Local Evals API accepts eval definitions, `purpose:"evals"` JSONL Files,
  synchronous Responses-template runs, deterministic `string_check` grading,
  result aggregation, output item list/get, run list/get, eval metadata update,
  and eval deletion.
