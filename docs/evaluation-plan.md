...
| `code-benchmark` | Small issue-to-patch coding tasks that generate complete replacement files, apply them, and run tests; includes the default `micro` suite plus the broader `humaneval-mbpp` function-repair suite |
