...
- Local Assistants compatibility runs deprecated Assistants/Threads workflows
  ...
  verifies run `additional_messages` and `additional_instructions`, including
